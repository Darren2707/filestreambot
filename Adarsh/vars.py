...
class Var(object):
    ...
    BIND_ADRESS = str(getenv('WEB_SERVER_BIND_ADDRESS', '13.232.129.62'))
    ...
    if 'DYNO' in environ:
        ...
        ON_HEROKU = False
    FQDN = str(getenv('FQDN', '13.232.129.62:56309')) if not ON_HEROKU or getenv('FQDN', '13.232.129.62:56309') else APP_NAME+'.herokuapp.com'
